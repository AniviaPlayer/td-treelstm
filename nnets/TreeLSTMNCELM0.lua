...
--[[
local function sparseMatrixRowAssignC(mat1, indices, mat2)
  for i = 1, indices:size(1) do
    mat1[{ indices[i], {} }] = mat2[{ i, {} }]
  end
end

local function sparseMatrixRowAcc(mat1, indices, mat2)
  for i = 1, indices:size(1) do
    mat1[{ indices[i], {} }]:add( mat2[{ indices[i], {} }] )
  end
end

local function sparseMatrixRowAcc0(mat1, indices, mat2, mat2Offset)
  for i = 1, indices:size(1) do
    mat1[{ indices[i], {} }]:add( mat2[{ indices[i] - mat2Offset, {} }] )
  end
end

local function sparseMatrixRowAccOffset(mat1, indices, mat2, mat2Offset)
  for i = 1, indices:size(1) do
    mat1[{ indices[i], {} }]:add( mat2[{ indices[i] - mat2Offset, {} }] )
  end
end

local function sparseMatrixRowAccC(mat1, indices, mat2)
  for i = 1, indices:size(1) do
    mat1[{ indices[i], {} }]:add( mat2[{ i, {} }] )
  end
end
--]]
...
function TreeLSTMNCELM:createNetwork(opts)
  ...
  local function createNCE()
    ...
    local nce_cost = NCE(opts.nhid, opts.novocab, self.nceZ, opts.learnZ)({h_t, y_t,
