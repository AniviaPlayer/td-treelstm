...
local BidTreeLM_Dataset = torch.class('BidTreeLM_Dataset')

function BidTreeLM_Dataset:__init(datasetPath)
...
function BidTreeLM_Dataset:getVocabSize()
  return self.vocab.nvocab
end

function BidTreeLM_Dataset:getTrainSize()
  return self.trainSize
end

function BidTreeLM_Dataset:getValidSize()
  return self.validSize
end

function BidTreeLM_Dataset:getTestSize()
  return self.testSize
end

function BidTreeLM_Dataset:toBatch(xs, ys, lcs, batchSize)
...
function BidTreeLM_Dataset:createBatch(label, batchSize)
  ...
  return function()
    if istart <= N then
      ...
      return self:toBatch(xs, ys, lcs, batchSize)
    end
  end
end

function BidTreeLM_Dataset:close()
  self.h5in:close()
end
