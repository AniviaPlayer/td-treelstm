...
dataset=/disk/scratch/XingxingZhang/treelstm/dataset/msr/msr.dep.100.sort20.h5
lr=1.0
label=.tree.400
...
testfile=/disk/scratch/XingxingZhang/treelstm/dataset/msr/msr.dep.100.question.h5
outfile=out.txt
rlog=rerank.$log
